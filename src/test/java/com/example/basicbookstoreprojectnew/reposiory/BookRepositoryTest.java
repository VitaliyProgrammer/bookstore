package com.example.basicbookstoreprojectnew.reposiory;
...
public class BookRepositoryTest extends CustomMySqlContainer {
    ...
    void saveBook() {
        ...
        assertThat(newBook.getTitle()).isEqualTo("Effective Java");
    }
