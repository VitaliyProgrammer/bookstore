...
public class BookServiceImplTest {
    ...
    void saveBook() {
        ...
        Book book = bookRepository.findById(savedBookDto.id())
                .orElseThrow(() -> new BookNotFoundException("Book not found during test!"));
    ...
    void saveBook_categoryNotFound() {
        ...
        assertThrows(CategoryNotFoundException.class, () -> bookService.save(saveBook));
    }
    ...
    void findById_bookNotFound() {
        ...
        assertThrows(BookNotFoundException.class, () -> bookService.findById(10000L));
    }
