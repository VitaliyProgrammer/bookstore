...
public class BookRepositoryTest {
    ...
    @Container
    private static final CustomMySqlContainer myCustomSqlContainer = CustomMySqlContainer.getInstance();
    ...
    void categoryNotFoundForBook() {
        ...
        assertThrows(Exception.class, () -> categoryRepository.findById(nonExistingCategoryById).orElseThrow(() -> new CategoryNotFoundException("Category with id " + nonExistingCategoryById + " not found!")));
    }
}
